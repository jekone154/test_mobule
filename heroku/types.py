...
class Module:
    ...
    async def request_join(
        ...
        _inline = getattr(self, "inline", None)
        _trans = self._client.loader.lookup("translations") if hasattr(self, "_client") else None
        if _inline and getattr(_inline, "bot", None) and _trans:
            await _inline.bot.send_photo(
                self.tg_id,
            ...
            reply_markup=_inline.generate_markup(
                [
                    {
                        "text": "💫 Approve",
